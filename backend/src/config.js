...
const namePrefix = "ZombieFeet";
const description = "Satisfying your need for Zombie Feet Pics";
...
const extraMetadata = {
    external_url: "https://zombiefeet.xyz", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'ZOMBIEFEET';
const CONTRACT_SYMBOL = 'FT';
